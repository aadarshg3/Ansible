==================================================
# 🧪 IP Address Validation using Character Checks

## 🔹 Method 1: Using `isalpha()` and symbol filtering
**🧠 Code:**
```python
...
```
**📌 Summary:**
- Filters out alphabetic and symbol characters before checking IP structure.
- IP is considered valid only if all 4 octets are within 0–255 range.

## 🔹 Method 2: Using `isdecimal()` for stricter numeric filtering
**🧠 Code:**
```python
ip = input("Enter your ip:")
...
```
**📌 Summary:**
- Relies on `isdecimal()` and exits early on failure.
- Efficient but assumes strict digit-only formatting before `split()`.

====================================
!! ip validation --> another ways!! 
